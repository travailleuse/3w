...
易得，\(\dis \angle POT_1 = \angle PP_1P_2,\ PT_1 = \cos\alpha\tan\beta, OP = \frac{OT_1}{\cos\beta} = \frac{\cos\alpha}{\cos\beta},\ PT =P_1P\sin\beta = (\sin\alpha - \cos\alpha\tan\beta)\sin\beta,\ P_1T=P_1P\cos\beta=(\sin\alpha - \cos\alpha\tan\beta)\cos\beta \)
则：
\begin{align*}
    \sin(\alpha - \beta) &= P_1T\\
...
利用上面两个方程，由克拉默法则解得：
\[
\Delta = (x_1-x_0)(y_2-y_0) - (x_2-x_0)(y_1-y_0)
\]
\begin{align*}
    a &= \frac{\big[(x_1^2+y_1^2)-(x_0^2+y_0^2)\big](y_2-y_0) - \big[(x_2^2+y_2^2)-(x_0^2+y_0^2)\big](y_1-y_0)}{2\Delta}\\[4pt]
    b &= \frac{(x_1-x_0)\big[(x_2^2+y_2^2)-(x_0^2+y_0^2)\big] - (x_2-x_0)\big[(x_1^2+y_1^2)-(x_0^2+y_0^2)\big]}{2\Delta}
\end{align*}